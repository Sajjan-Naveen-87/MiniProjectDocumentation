...
I hereby declare that the work presented in this project report is my own original work, carried out under the guidance of my faculty supervisor. All sources of information have been duly acknowledged. The software implementation was developed by me as a full-stack engineer, encompassing both frontend (Next.js) and backend (Python/FastAPI) components.

\vspace{1cm}\hspace{8cm} S Naveen (230101099)
