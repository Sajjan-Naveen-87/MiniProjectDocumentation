...
The following timeline illustrates the overlap and duration of key developmental phases:
...
\begin{ganttchart}[
    ...
    \ganttbar{Voice Core}{2026-04-04}{2026-04-07} \\
    \ganttbar{Math Rendering}{2026-04-08}{2026-04-14} \\
    \ganttbar{UI \& Analytics}{2026-04-15}{2026-04-18} \\
    \ganttbar{Security \& Scaling}{2026-04-19}{2026-04-22} \\
    \ganttbar{Final Integration}{2026-04-23}{2026-04-24}
\end{ganttchart}
\caption{Development Timeline for Origin AI Phases}
\label{fig:gantt}
\end{figure}
...
Op. Cost per Query & ₹1.25 (high) & Low (human-dependent) & ₹1.00 (medium) & \textbf{₹0.18 (low)} \\ \hline
...
\textbf{Advantage of In-Situ Mentorship:}  
improved student satisfaction from 3.2/5 to 4.7/5.
