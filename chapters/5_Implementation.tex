...
To handle the display of complex mathematical formulas, we implemented a custom React component `MathText`. This component uses a regex-based parser to identify LaTeX delimiters (e.g., `$ ... $` or `\begin{equation} ... \end{equation}`) and renders them using \textbf{KaTeX} for high-performance typesetting.
